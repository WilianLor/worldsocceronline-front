...
const Signup: React.FC = () => {
  ...
  const [passwordConfirmFieldState, setPasswordConfirmFieldState] =
    useState("passwordConfirm");
  ...
  return (
    <RegisterPage>
      <FormRegister onSubmit={(e) => e.preventDefault()}>
        ...
        <Section>
          ...
          <Input
            ...
            required
            name="username"
            id={usernameFieldState}
            placeholder="Nome de usuário"
            onChange={(e) => {
              setUsername(e.target.value);
              setUsernameFieldState("username");
              setError("");
            }}
          />

          <Select
            placeholder="Selecione uma país"
            required
            name="country"
            id={countryFieldState}
            onChange={(e) => {
              setCountry(e.target.value);
              setCountryFieldState("country");
              setError("");
            }}
          >
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              setPasswordConfirmFieldState("passwordConfirm");
              setError("");
            }}
          />
          <Input
      ...
      <RegisterContent>
        ...
        <ContentText>
          Seja um treinador ou presidente de qualquer clube do mundo do futebol
        </ContentText>
